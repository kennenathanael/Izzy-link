<?php $__env->startSection('title', $tr['pay_tag'] ?? 'App Activation'); ?>
                ...
                <li class="breadcrumb-item">
                    <a href="<?php echo e(url('/')); ?>"
                       style="color:rgba(255,255,255,0.55);font-size:0.82rem;">
                        <?php echo e($tr['breadcrumb_home']); ?>

                    </a>
                </li>
                <li class="breadcrumb-item active"
                    style="color:var(--accent);font-size:0.82rem;">
                    <?php echo e($tr['pay_tag']); ?>
...
<section style="background:#f4f7fc;padding:60px 0;">
    <div class="container">
        <div class="text-center mb-5" data-aos="fade-up">
            <div class="section-label"><?php echo e($tr['pay_unlock_label']); ?></div>
            <h2 class="section-title"><?php echo e($tr['pay_unlock_title']); ?></h2>
        ...
        <div class="row g-4">
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="0">
                <div class="unlock-card">
                    ...
                    <h5 class="uc-title"><?php echo e($tr['pay_f1_title']); ?></h5>
                    <p class="uc-desc"><?php echo e($tr['pay_f1_desc']); ?></p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <div class="unlock-card">
                    ...
                    <h5 class="uc-title"><?php echo e($tr['pay_f2_title']); ?></h5>
                    <p class="uc-desc"><?php echo e($tr['pay_f2_desc']); ?></p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="unlock-card">
                    ...
                    <h5 class="uc-title"><?php echo e($tr['pay_f3_title']); ?></h5>
                    <p class="uc-desc"><?php echo e($tr['pay_f3_desc']); ?></p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
                <div class="unlock-card">
                    ...
                    <h5 class="uc-title"><?php echo e($tr['pay_f4_title']); ?></h5>
                    <p class="uc-desc"><?php echo e($tr['pay_f4_desc']); ?></p>
                </div>
            </div>
        </div>
    </div>
...
<section class="section-padding" id="pricing" style="background:#fff;">
    <div class="container">
        <div class="text-center mb-5" data-aos="fade-up">
            <div class="section-label"><?php echo e($tr['pay_plans_label']); ?></div>
            <h2 class="section-title"><?php echo e($tr['pay_plans_title']); ?></h2>
            <div class="divider-accent mx-auto"></div>
            <p style="color:#6c7a89;font-size:0.95rem;max-width:560px;margin:0 auto;">
                <?php echo e($tr['pay_plans_sub']); ?>
        ...
        <div class="row g-4 justify-content-center" id="plans-row">
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="0">
                <div class="pricing-card" id="plan-basic"
                     onclick="selectPlan('basic','<?php echo e($tr['pay_plan_basic']); ?>','25,000 FCFA')">
                    <div class="pc-top">
                        <div class="pc-name"><?php echo e($tr['pay_plan_basic']); ?></div>
                        <div class="pc-price">
                            <span class="pc-currency">FCFA</span>
                            <span class="pc-amount">25,000</span>
                        </div>
                        <div class="pc-period"><?php echo e($tr['pay_per_service']); ?></div>
                    </div>
                    <div class="pc-features">
                        <div class="pcf-item">
                            <i class="bi bi-check-circle-fill"></i>
                            <?php echo e($tr['pay_basic_f1']); ?>

                        </div>
                        <div class="pcf-item">
                            <i class="bi bi-check-circle-fill"></i>
                            <?php echo e($tr['pay_basic_f2']); ?>

                        </div>
                        <div class="pcf-item">
                            <i class="bi bi-check-circle-fill"></i>
                            <?php echo e($tr['pay_basic_f3']); ?>

                        </div>
                        <div class="pcf-item">
                            <i class="bi bi-check-circle-fill"></i>
                            <?php echo e($tr['pay_basic_f4']); ?>

                        </div>
                    </div>
                    <button class="pc-btn" id="btn-basic">
                        <i class="bi bi-arrow-right-circle-fill"></i>
                        <?php echo e($tr['pay_choose']); ?>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="150">
                <div class="pricing-card featured-plan" id="plan-pro"
                     onclick="selectPlan('pro','<?php echo e($tr['pay_plan_pro']); ?>','50,000 FCFA')">
                    <div class="pc-popular-tag">
                        <i class="bi bi-star-fill"></i>
                        <?php echo e($tr['pay_popular']); ?>

                    </div>
                    <div class="pc-top featured-top">
                        <div class="pc-name" style="color:#fff;">
                            <?php echo e($tr['pay_plan_pro']); ?>
                    ...
                    <div class="pc-features featured-features">
                        <div class="pcf-item" style="color:#fff;">
                            ...
                            <?php echo e($tr['pay_pro_f1']); ?>

                        </div>
                        <div class="pcf-item" style="color:#fff;">
                            <i class="bi bi-check-circle-fill"
                               style="color:var(--accent);"></i>
                            <?php echo e($tr['pay_pro_f2']); ?>

                        </div>
                        <div class="pcf-item" style="color:#fff;">
                            <i class="bi bi-check-circle-fill"
                               style="color:var(--accent);"></i>
                            <?php echo e($tr['pay_pro_f3']); ?>

                        </div>
                        <div class="pcf-item" style="color:#fff;">
                            <i class="bi bi-check-circle-fill"
                               style="color:var(--accent);"></i>
                            <?php echo e($tr['pay_pro_f4']); ?>

                        </div>
                        <div class="pcf-item" style="color:#fff;">
                            <i class="bi bi-check-circle-fill"
                               style="color:var(--accent);"></i>
                            <?php echo e($tr['pay_pro_f5']); ?>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                <div class="pricing-card" id="plan-enterprise"
                     onclick="selectPlan('enterprise','<?php echo e($tr['pay_plan_enterprise']); ?>','100,000 FCFA')">
                    <div class="pc-top">
                        <div class="pc-name"><?php echo e($tr['pay_plan_enterprise']); ?></div>
                        <div class="pc-price">
                            <span class="pc-currency">FCFA</span>
                            <span class="pc-amount">100,000</span>
                        </div>
                        <div class="pc-period"><?php echo e($tr['pay_per_month']); ?></div>
                    </div>
                    <div class="pc-features">
                        <div class="pcf-item">
                            <i class="bi bi-check-circle-fill"></i>
                            <?php echo e($tr['pay_ent_f1']); ?>

                        </div>
                        <div class="pcf-item">
                            <i class="bi bi-check-circle-fill"></i>
                            <?php echo e($tr['pay_ent_f2']); ?>

                        </div>
                        <div class="pcf-item">
                            <i class="bi bi-check-circle-fill"></i>
                            <?php echo e($tr['pay_ent_f3']); ?>

                        </div>
                        <div class="pcf-item">
                            <i class="bi bi-check-circle-fill"></i>
                            <?php echo e($tr['pay_ent_f4']); ?>

                        </div>
                        <div class="pcf-item">
                            <i class="bi bi-check-circle-fill"></i>
                            <?php echo e($tr['pay_ent_f5']); ?>

                        </div>
                        <div class="pcf-item">
                            <i class="bi bi-check-circle-fill"></i>
                            <?php echo e($tr['pay_ent_f6']); ?>
            ...
            <div class="col-lg-10">
                ...
                <div class="selected-plan-banner mb-5" data-aos="fade-down">
                    <div class="spb-left">
                        ...
                        <div>
                            <div class="spb-label"><?php echo e($tr['pay_selected_plan']); ?></div>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5" data-aos="fade-right">
                        <div class="pm-section-title">
                            ...
                            <?php echo e($tr['pay_method_title']); ?>
                        ...
                        <div class="payment-method-card active" id="pm-mtn"
                            ...
                            <div class="pmc-instructions" id="inst-mtn">
                                <div class="pmc-inst-title"><?php echo e($tr['pay_mtn_inst']); ?></div>
                                <div class="pmc-step">
                        ...
                        <div class="payment-method-card" id="pm-orange"
                            ...
                            <div class="pmc-instructions" id="inst-orange"
                                 style="display:none;">
                                <div class="pmc-inst-title"><?php echo e($tr['pay_orange_inst']); ?></div>
                                <div class="pmc-step">
                                    <div class="pmc-step-num">1</div>
                        ...
                        <div class="payment-method-card" id="pm-card"
                            ...
                            <div class="pmc-instructions" id="inst-card"
                                 style="display:none;">
                                <div class="pmc-inst-title"><?php echo e($tr['pay_card_inst']); ?></div>
                                <div class="pmc-step">
                                    <div class="pmc-step-num">1</div>
                                    <div><?php echo e($tr['pay_card_s1']); ?></div>
                                </div>
                                <div class="pmc-step">
                                    <div class="pmc-step-num">2</div>
                                    <div><?php echo e($tr['pay_card_s2']); ?></div>
                                </div>
                                <div class="pmc-step">
                                    <div class="pmc-step-num">3</div>
                                    <div><?php echo e($tr['pay_card_s3']); ?></div>
                                </div>
                                <div class="pmc-step">
                                    <div class="pmc-step-num">4</div>
                                    <div><?php echo e($tr['pay_card_s4']); ?></div>
                                </div>
                    ...
                    <div class="col-lg-7" data-aos="fade-left">
                        <div class="pay-confirm-card">
                            <div class="pcc-header">
                                <i class="bi bi-shield-fill-check"></i>
                                <?php echo e($tr['pay_confirm_title']); ?>
                            ...
                            <form method="POST" action="<?php echo e(url('/payment/process')); ?>"
                                ...
                                <div class="row g-3 mb-4">
                                    <div class="col-md-6">
                                        <label class="form-label-custom">
                                            <?php echo e($tr['full_name']); ?> *
                                        </label>
                                        <input type="text" name="full_name"
                                               class="input-custom" required
                                               placeholder="<?php echo e($tr['full_name']); ?>"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="file-upload-box">
                                            ...
                                            <label for="proof-upload"
                                                ...
                                                <i class="bi bi-cloud-upload-fill"></i>
                                                <div class="fub-title">
                                                    <?php echo e($tr['pay_proof_click']); ?>

                                                </div>
                                                <div class="fub-hint">
                                                    <?php echo e($tr['pay_proof_hint']); ?>
                                    ...
                                    <div class="col-12">
                                        <label class="form-label-custom">
                                            <?php echo e($tr['pay_notes_opt']); ?>

                                        </label>
                                        <textarea name="notes" class="input-custom"
                                                  rows="2"
                                                  placeholder="<?php echo e($tr['notes_ph']); ?>"><?php echo e(old('notes')); ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="pay-summary">
                                    <div class="ps-row">
                                        <span class="ps-label"><?php echo e($tr['pay_service']); ?></span>
                                        <span class="ps-value"><?php echo e($tr['pay_service_name']); ?></span>
                                    </div>
                                    <div class="ps-row">
                                        <span class="ps-label"><?php echo e($tr['pay_selected_plan']); ?></span>
                                        <span class="ps-value" id="summary-plan">Pro</span>
                                    </div>
                                    <div class="ps-row">
                                        <span class="ps-label"><?php echo e($tr['pay_amount']); ?></span>
                                        <span class="ps-value ps-amount"
                                              id="summary-amount">50,000 FCFA</span>
                                    </div>
                                    <div class="ps-row">
                                        <span class="ps-label"><?php echo e($tr['pay_method_lbl']); ?></span>
                                ...
                                <div class="form-notice mt-3">
                                    ...
                                    <?php echo e($tr['pay_notice']); ?>

                                </div>

                                <button type="submit" class="btn-pay-confirm mt-4">
                                    <i class="bi bi-shield-fill-check"></i>
                                    <?php echo e($tr['pay_confirm_btn']); ?>
...
function selectPlan(plan, label, price) {
    ...
    ['basic','pro','enterprise'].forEach(p => {
        ...
        if (p === plan) {
            btn.innerHTML = '<i class="bi bi-check-circle-fill"></i> <?php echo e($tr['pay_selected']); ?>';
            btn.classList.add('plan-selected');
        } else {
            btn.innerHTML = '<i class="bi bi-arrow-right-circle-fill"></i> <?php echo e($tr['pay_choose']); ?>';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\GENERAL STORES\Downloads\IzzyLink-app\resources\views/payment/index.blade.php ENDPATH**/ ?>