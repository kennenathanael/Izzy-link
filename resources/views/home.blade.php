    ...
    <div class="container">
        <div class="row align-items-center" style="min-height:88vh;padding:80px 0 120px;">
            <div class="col-lg-6" data-aos="fade-right">
                ...
                <h1 class="hero-title">
                    {{ $tr['hero_title1'] }}<br>
                    <span class="hero-highlight">{{ $tr['hero_title2'] }}</span><br>
                    {{ $tr['hero_title3'] }}
                </h1>
                <p class="hero-subtitle">{{ $tr['hero_sub'] }}</p>
                <div class="d-flex gap-3 flex-wrap mb-5">
                    <a href="{{ url('/driving') }}" class="btn-hero-primary">
                ...
                <div class="hero-stats-bar">
                    <div class="hsb-item">
                        ...
                        <div class="hsb-label">{{ $tr['hero_students'] }}</div>
                    </div>
                    <div class="hsb-divider"></div>
                    <div class="hsb-item">
                        <div class="hsb-number">5</div>
                        <div class="hsb-label">{{ $tr['hero_centers'] }}</div>
                    </div>
                    <div class="hsb-divider"></div>
                    <div class="hsb-item">
                        <div class="hsb-number">3</div>
                        <div class="hsb-label">{{ $tr['hero_countries'] }}</div>
                    </div>
                    <div class="hsb-divider"></div>
                    <div class="hsb-item">
                        <div class="hsb-number">98%</div>
                        <div class="hsb-label">{{ $tr['hero_success'] }}</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 d-none d-lg-flex justify-content-center align-items-center" data-aos="fade-left">
                <div class="hero-visual">
                    ...
                    <div class="hv-float hv-f1">
                        ...
                        <div>
                            <div class="hvf-title">{{ $tr['driving'] }}</div>
                            <div class="hvf-sub">4 {{ $tr['hero_centers'] }}</div>
                        </div>
                    </div>
                    <div class="hv-float hv-f2">
                        ...
                        <div>
                            <div class="hvf-title">{{ $tr['language'] }}</div>
                    ...
                    <div class="hv-float hv-f3">
                        ...
                        <div>
                            <div class="hvf-title">{{ $tr['visa'] }}</div>
...
<section class="section-padding" style="background:#f4f7fc;">
    <div class="container">
        <div class="text-center mb-5" data-aos="fade-up">
            <div class="section-label">{{ $tr['services_label'] }}</div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="0">
                <div class="svc-card">
                    <div class="svc-header" style="background:linear-gradient(135deg,#1a3c6e,#2a5298);">
                        ...
                        <div>
                            <div class="svc-tag">{{ $tr['driving_tag'] }}</div>
                            <div class="svc-name">Easy Driving</div>
                        </div>
                        <div class="svc-num">01</div>
                    </div>
                    <div class="svc-body">
                        <p class="svc-desc">{{ $tr['driving_desc'] }}</p>
                        <ul class="svc-list">
                            <li><i class="bi bi-check-circle-fill"></i> {{ $tr['driving_f1'] }}</li>
                            <li><i class="bi bi-check-circle-fill"></i> {{ $tr['driving_f2'] }}</li>
                            <li><i class="bi bi-check-circle-fill"></i> {{ $tr['driving_f3'] }}</li>
                            <li><i class="bi bi-check-circle-fill"></i> {{ $tr['driving_f4'] }}</li>
                        </ul>
                        <div class="svc-actions">
                            <a href="{{ url('/driving') }}" class="svc-btn-main">
                                {{ $tr['learn_more'] }} <i class="bi bi-arrow-right"></i>
                            </a>
                            <a href="#main-app" target="_blank" class="svc-btn-alt">
                                <i class="bi bi-box-arrow-up-right"></i> {{ $tr['register_now'] }}
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="150">
                <div class="svc-card featured-svc">
                    <div class="svc-popular">{{ $tr['most_popular'] }}</div>
                    <div class="svc-header" style="background:linear-gradient(135deg,#c8860f,#e8a020);">
                        ...
                        <div>
                            ...
                            <div class="svc-name">{{ $tr['language'] }}</div>
                        </div>
                        <div class="svc-num">02</div>
                    </div>
                    <div class="svc-body">
                        <p class="svc-desc">{{ $tr['lang_desc'] }}</p>
                        <ul class="svc-list">
                            <li><i class="bi bi-check-circle-fill"></i> {{ $tr['lang_f1'] }}</li>
                            <li><i class="bi bi-check-circle-fill"></i> {{ $tr['lang_f2'] }}</li>
                            <li><i class="bi bi-check-circle-fill"></i> {{ $tr['lang_f3'] }}</li>
                            <li><i class="bi bi-check-circle-fill"></i> {{ $tr['lang_f4'] }}</li>
                        </ul>
                        <div class="svc-actions">
                            <a href="{{ url('/language') }}" class="svc-btn-main">
                                {{ $tr['learn_more'] }} <i class="bi bi-arrow-right"></i>
                            </a>
                            <a href="#main-app" target="_blank" class="svc-btn-alt">
                                <i class="bi bi-box-arrow-up-right"></i> {{ $tr['enroll_now'] }}
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                <div class="svc-card">
                    <div class="svc-header" style="background:linear-gradient(135deg,#1a6e3c,#28a745);">
                        ...
                        <div>
                            <div class="svc-tag">{{ $tr['visa_tag'] }}</div>
                            <div class="svc-name">{{ $tr['visa'] }}</div>
                        </div>
                        <div class="svc-num">03</div>
                    </div>
                    <div class="svc-body">
                        <p class="svc-desc">{{ $tr['visa_desc'] }}</p>
                        <ul class="svc-list">
                            <li><i class="bi bi-check-circle-fill"></i> {{ $tr['visa_f1'] }}</li>
                            <li><i class="bi bi-check-circle-fill"></i> {{ $tr['visa_f2'] }}</li>
                            <li><i class="bi bi-check-circle-fill"></i> {{ $tr['visa_f3'] }}</li>
                            <li><i class="bi bi-check-circle-fill"></i> {{ $tr['visa_f4'] }}</li>
                        </ul>
                        <div class="svc-actions">
                            <a href="{{ url('/visa') }}" class="svc-btn-main">
                                {{ $tr['learn_more'] }} <i class="bi bi-arrow-right"></i>
                            </a>
                            <a href="#main-app" target="_blank" class="svc-btn-alt">
                                <i class="bi bi-box-arrow-up-right"></i> {{ $tr['apply_now'] }}
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row align-items-center g-5">
            <div class="col-lg-5" data-aos="fade-right">
                <div class="section-label">{{ $tr['why_label'] }}</div>
                ...
                <div class="row g-3">
                    <div class="col-6">
                        <div class="stat-block"
                            ...
                            <div class="sb-label">{{ $tr['stat_students'] }}</div>
                    ...
                    <div class="col-6">
                        <div class="stat-block"
                            ...
                            <div class="sb-label">{{ $tr['stat_visa'] }}</div>
                    ...
                    <div class="col-6">
                        <div class="stat-block"
                            ...
                            <div class="sb-label">{{ $tr['stat_centers'] }}</div>
                    ...
                    <div class="col-6">
                        <div class="stat-block"
                            ...
                            <div class="sb-label">{{ $tr['stat_countries'] }}</div>
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="0">
                <div class="country-card">
                    ...
                    <div class="cc-tags">
                        <span>{{ $tr['visa_de_study'] }}</span>
                        <span>{{ $tr['visa_de_work'] }}</span>
                        <span>{{ $tr['visa_de_biz'] }}</span>
                    </div>
                    <p class="cc-desc">{{ $tr['visa_de_desc'] }}</p>
                    <a href="{{ url('/visa') }}" class="cc-btn">
                        {{ $tr['start_application'] }} <i class="bi bi-arrow-right"></i>
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="150">
                <div class="country-card">
                    ...
                    <div class="cc-tags">
                        <span>{{ $tr['visa_fr_student'] }}</span>
                    </div>
                    <p class="cc-desc">{{ $tr['visa_fr_desc'] }}</p>
                    <a href="{{ url('/visa') }}" class="cc-btn">
                        {{ $tr['start_application'] }} <i class="bi bi-arrow-right"></i>
                    </a>
                </div>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                <div class="country-card">
                    ...
                    <div class="cc-tags">
                        <span>{{ $tr['visa_lt_student'] }}</span>
                    </div>
                    <p class="cc-desc">{{ $tr['visa_lt_desc'] }}</p>
                    <a href="{{ url('/visa') }}" class="cc-btn">
                        {{ $tr['start_application'] }} <i class="bi bi-arrow-right"></i>
                    </a>
                </div>
...
<section class="section-padding" style="background:#f4f7fc;">
    <div class="container">
        <div class="text-center mb-5" data-aos="fade-up">
            <div class="section-label">{{ $tr['how_label'] }}</div>
            <h2 class="section-title">{{ $tr['how_title'] }}</h2>
            <div class="divider-accent mx-auto"></div>
        </div>
        <div class="row g-4">
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="0">
                <div class="step-card">
                    ...
                    <h5 class="step-title">{{ $tr['how_s1_title'] }}</h5>
                    <p class="step-desc">{{ $tr['how_s1_desc'] }}</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <div class="step-card">
                    ...
                    <h5 class="step-title">{{ $tr['how_s2_title'] }}</h5>
                    <p class="step-desc">{{ $tr['how_s2_desc'] }}</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="step-card">
                    ...
                    <h5 class="step-title">{{ $tr['how_s3_title'] }}</h5>
                    <p class="step-desc">{{ $tr['how_s3_desc'] }}</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
                <div class="step-card">
                    ...
                    <h5 class="step-title">{{ $tr['how_s4_title'] }}</h5>
                    <p class="step-desc">{{ $tr['how_s4_desc'] }}</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="section-padding" style="background:#fff;">
    <div class="container">
        <div class="text-center mb-5" data-aos="fade-up">
            <div class="section-label">{{ $tr['centers_label'] }}</div>
            <h2 class="section-title">{{ $tr['centers_title'] }}</h2>
            <div class="divider-accent mx-auto"></div>
            <p style="color:#6c7a89;font-size:0.95rem;">{{ $tr['centers_sub'] }}</p>
        </div>
        ...
        <div class="row g-4 mb-4">
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="0">
                <div class="center-card hq-card">
                    <div class="cc-hq-badge">{{ $tr['headquarters'] }}</div>
                    ...
                    <div class="cc-services-tags">
                        <span>{{ $tr['driving_tag'] }}</span>
                        <span>{{ $tr['language'] }}</span>
                        <span>{{ $tr['visa'] }}</span>
                    </div>
                    <a href="{{ url('/locations#carrefour') }}" class="cc-link">
                        {{ $tr['view_center'] }} <i class="bi bi-arrow-right"></i>
                    </a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <div class="center-card">
                    ...
                    <a href="{{ url('/locations#nkomo') }}" class="cc-link">
                        {{ $tr['view_center'] }} <i class="bi bi-arrow-right"></i>
                    </a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="center-card">
                    ...
                    <a href="{{ url('/locations#essos') }}" class="cc-link">
                        {{ $tr['view_center'] }} <i class="bi bi-arrow-right"></i>
                    </a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
                <div class="center-card">
                    ...
                    <a href="{{ url('/locations#bonas') }}" class="cc-link">
                        {{ $tr['view_center'] }} <i class="bi bi-arrow-right"></i>
                    </a>
                </div>
            </div>
        ...
        <div class="row g-4">
            <div class="col-lg-4 col-md-6" data-aos="fade-up">
                <div class="center-card">
                    ...
                    <a href="{{ url('/locations#makepe') }}" class="cc-link">
                        {{ $tr['view_center'] }} <i class="bi bi-arrow-right"></i>
                    </a>
                </div>
            </div>
        ...
        <div class="cta-box" data-aos="zoom-in">
            <div class="row align-items-center g-4">
                ...
                <div class="col-lg-5 d-flex gap-3 flex-wrap justify-content-lg-end">
                    <a href="{{ url('/payment') }}" class="btn-hero-primary">
