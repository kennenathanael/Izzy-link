@extends('layouts.app')
@section('title', $tr['reg_title'] ?? 'Register')
        ...
        <div class="row justify-content-center">
            <div class="col-md-5">
                <div class="auth-card" data-aos="fade-up">
                    ...
                    <h3 class="auth-title">{{ $tr['reg_title'] }}</h3>
                    <p class="auth-sub">{{ $tr['reg_sub'] }}</p>
                    ...
                    <form method="POST" action="{{ url('/register') }}">
                        @csrf
                        <div class="mb-3">
                            <label class="auth-label">{{ $tr['reg_name'] }}</label>
                            <input type="text" name="name"
                                   class="auth-input" required
                                   placeholder="{{ $tr['reg_name'] }}"
                                   value="{{ old('name') }}"/>
                        </div>
                        <div class="mb-3">
                            <label class="auth-label">{{ $tr['reg_email'] }}</label>
                        ...
                        <div class="mb-4">
                            <label class="auth-label">{{ $tr['reg_password'] }}</label>
                    ...
                    <p class="auth-switch">
                        {{ $tr['reg_have'] }}
                        <a href="{{ url('/login') }}">{{ $tr['reg_login'] }}</a>
                    </p>
                </div>
            </div>
        </div>
