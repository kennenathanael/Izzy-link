@extends('layouts.app')
@section('title', $tr['login_title'] ?? 'Login')
        ...
        <div class="row justify-content-center">
            <div class="col-md-5">
                <div class="auth-card" data-aos="fade-up">
                    ...
                    <h3 class="auth-title">{{ $tr['login_title'] }}</h3>
                    <p class="auth-sub">{{ $tr['login_sub'] }}</p>
                    ...
                    <form method="POST" action="{{ url('/login') }}">
                        @csrf
                        <div class="mb-3">
                            <label class="auth-label">{{ $tr['login_email'] }}</label>
                        ...
                        <div class="mb-4">
                            <label class="auth-label">{{ $tr['login_password'] }}</label>
                    ...
                    <p class="auth-switch">
                        {{ $tr['login_no_account'] }}
                        <a href="{{ url('/register') }}">{{ $tr['login_register'] }}</a>
                    </p>
                </div>
            </div>
        </div>
